...
public class JobEntryZipFile extends JobEntryBase implements Cloneable, JobEntryInterface {
  ...
  public String getXML() {
    ...
    retval.append( "      " ).append( XMLHandler.addTagValue( "zippass", zipPass ) );
  ...
  public void loadXML( Node entrynode, List<DatabaseMeta> databases, List<SlaveServer> slaveServers,
    ...
    try {
      ...
      //加密字段
      zipPass = XMLHandler.getTagValue(entrynode, "zippass");
  ...
  public void loadRep( Repository rep, IMetaStore metaStore, ObjectId id_jobentry, List<DatabaseMeta> databases,
    ...
    try {
      ...
      //加密字段
      zipPass = rep.getJobEntryAttributeString( id_jobentry, "zippass" );
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_job ) throws KettleException {
    try {
      ...
      rep.saveJobEntryAttribute( id_job, getObjectId(), "zippass", zipPass );
  ...
  public boolean processRowFile( Job parentJob, Result result, String realZipfilename, String realWildcard,
    String realZippass, String realWildcardExclude, String realSourceDirectoryOrFile, String realMovetodirectory,
      ...
      try {
        ...
        if ( ifZipFileExists == 3 && Fileexists ) {
          ...
          if ( fileList.length == 0 ) {
            ...
            String pass = String.valueOf(zipPass);
  ...
  public Result execute( Result previousResult, int nr ) {
    ...
    if ( isFromPrevious && rows != null ) {
        ...
        for ( int iteration = 0; iteration < rows.size() && !parentJob.isStopped(); iteration++ ) {
          ...
          if ( !Const.isEmpty( realTargetdirectory ) ) {
            ...
            if ( !Const.isEmpty( realZipfilename ) ) {
              if ( !processRowFile(
                parentJob, result, realZipfilename, realWildcard, realZippass,realWildcardExclude, realTargetdirectory,
      ...
      if ( !Const.isEmpty( sourceDirectory ) ) {
        ...
        realZippass = environmentSubstitute( zipPass );
