...
public class GaInputPlusStepMeta extends BaseStepMeta implements StepMetaInterface {
	...
	private String gaServiceAccountEmail;
	...
	//2015 新版本服务账号
	public String getGaSAEmail() {
		return gaServiceAccountEmail;
	}

	public void setGaSAEmail(String serviceAccountEmail) {
		this.gaServiceAccountEmail = serviceAccountEmail;
	}
	//2015 新版本服务账号
	...
	public void setDefault() {
		...
		gaEmail = "account@googlemail.com";
		gaServiceAccountEmail="your.@developer.gserviceaccount.com";
		segmentId = "gaid::-1";
		segmentName = "All Visits";
		dimensions = "ga:date,ga:keyword";
		metrics = "ga:sessions,ga:pageviews,ga:bounces,ga:newusers,ga:metric1";
		startDate = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
		endDate = new String(startDate);
		sort = "";
		gaAppName = DEFAULT_GA_APPLICATION_NAME;
		rowLimit = 0;
		gaApiKey = "F:\\GA\\google api connect-255fbf97dece.p12";
	...
	public Object clone() {
		...
		GaInputPlusStepMeta retval = (GaInputPlusStepMeta) super.clone();
	...
	public String getXML() throws KettleValueException {
		...
		//新版本
		retval.append("    ").append(XMLHandler.addTagValue("userServiceAccount", gaServiceAccountEmail));
	...
	public void loadXML(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleXMLException {
		...
		try {
			...
			gaServiceAccountEmail = XMLHandler.getTagValue(stepnode, "userServiceAccount");
			...
			throw new KettleXMLException(BaseMessages.getString(PKG, "GoogleAnalyticsPlus.Error.UnableToReadFromXML"), e);
		}
	...
	public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException {
		try {
			...
			gaServiceAccountEmail = rep.getStepAttributeString(id_step, "userServiceAccount");
			...
			throw new KettleException(BaseMessages.getString(PKG, "GoogleAnalyticsPlus.Error.UnableToReadFromRep"), e);
		}
	}
	...
	public void saveRep(Repository rep, ObjectId id_transformation, ObjectId id_step) throws KettleException {
		try {
			...
			rep.saveStepAttribute(id_transformation, id_step, "userServiceAccount", gaServiceAccountEmail);
			...
			throw new KettleException(BaseMessages.getString(PKG, "GoogleAnalyticsPlus.Error.UnableToSaveToRep") + id_step, e);
		}
	}
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transmeta, StepMeta stepinfo, RowMetaInterface prev, String input[], String output[], RowMetaInterface info) {
		...
		{
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "GoogleAnalyticsPlus.CheckResult.NotReceivingFields"), stepinfo); //$NON-NLS-1$
			remarks.add(cr);
		}
		else
		{
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "GoogleAnalyticsPlus.CheckResult.StepRecevingData",prev.size()+""), stepinfo); //$NON-NLS-1$ //$NON-NLS-2$
			remarks.add(cr);
		}
		...
		if (input.length>0)
		{
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "GoogleAnalyticsPlus.CheckResult.StepRecevingData2"), stepinfo); //$NON-NLS-1$
			remarks.add(cr);
		}
		else
		{
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "GoogleAnalyticsPlus.CheckResult.NoInputReceivedFromOtherSteps"), stepinfo); //$NON-NLS-1$
			remarks.add(cr);
		}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new GaInputPlusStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}

	public StepDataInterface getStepData() {
		return new GaInputPlusStepData();
	}
